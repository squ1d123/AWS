default["confluent"]["version"] = "3.0.0"
...
default["confluent"]["kafka"]["server.properties"] = {'auto.create.topics.enable'=> 'true', 'listners' => 'listeners=PLAINTEXT://0.0.0.0:9092', 'advertised.host.name' => node['ipaddress']}
